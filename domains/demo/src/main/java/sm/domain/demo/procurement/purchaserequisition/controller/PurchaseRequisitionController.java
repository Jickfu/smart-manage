package sm.domain.demo.procurement.purchaserequisition.controller;
...
import sm.domain.demo.procurement.purchaserequisition.model.form.PurchaseRequisitionListForm;
import sm.domain.demo.procurement.purchaserequisition.model.form.PurchaseRequisitionDeleteForm;
...
import sm.domain.demo.procurement.purchaserequisition.model.form.PurchaseRequisitionExportForm;
import sm.domain.sys.base.fileartifact.contract.FileArtifactReference;
import sm.domain.demo.procurement.purchaserequisition.model.vo.PurchaseRequisitionCreateNewDataVO;
import sm.domain.demo.procurement.purchaserequisition.model.vo.PurchaseRequisitionDetailVO;
import sm.domain.demo.procurement.purchaserequisition.model.vo.PurchaseRequisitionListVO;
import sm.domain.demo.procurement.purchaserequisition.model.vo.PurchaseRequisitionHomeSummaryVO;
import sm.domain.demo.procurement.purchaserequisition.service.PurchaseRequisitionService;
...
public class PurchaseRequisitionController {
    ...
    @PostMapping("/demo/procurement/purchase-requisition/export")
    ...
    @PostMapping("/demo/procurement/purchase-requisition/listPage")
    ...
    @PostMapping("/demo/procurement/purchase-requisition/detail")
    ...
    @GetMapping("/demo/procurement/purchase-requisition/createNewData")
    ...
    @PostMapping("/demo/procurement/purchase-requisition/delete")
