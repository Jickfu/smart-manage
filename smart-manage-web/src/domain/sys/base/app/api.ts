...
export function fetchApps() {
  return request.get<Result<DomainAppsVO[]>>('/sys/base/app/apps').then((res) => res.data.data);
}
...
export function fetchAppsAll() {
  return request.get<Result<DomainAppsVO[]>>('/sys/base/app/appsAll').then((res) => res.data.data);
}
