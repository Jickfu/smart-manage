...
class SlowSqlServiceTests {
    ...
    void setUp() {
        ...
        service = new SlowSqlService(instanceRegistry, mock(MonitorRoutingGateway.class), accessor);
    ...
    @Test
    void updateThresholdChangesLocalStatFilter() {
    ...
    @Test
    void clearClearsLocalStatistics() {
