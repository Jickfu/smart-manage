...
class RoleDataScopeMapperPostgresTests {
    private static final String RESOURCE_TYPE = "test.document";
    ...
    private static final long CUSTOM_ORG_ID = 900000000000000040L;
    ...
    private void seedFixtures(SqlSession session) throws Exception {
        // 权限夹具由本测试事务创建，不依赖发行基线中的演示部门。
        execute(session, "INSERT INTO t_sys_org (id,name,number,parent_id,number_path,name_path,org_type) VALUES "
                + "(" + CUSTOM_ORG_ID + ", '测试部门', 'verify-department', 1, 'SM/verify-department', 'SM/测试部门', 'DEPARTMENT')");
