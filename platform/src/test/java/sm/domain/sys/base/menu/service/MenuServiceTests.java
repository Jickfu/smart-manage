...
class MenuServiceTests {
    ...
    void userMenuReturnsRootPageWithoutSyntheticGroup() {
        ...
        appInfo.setAppNumber("test-app");
        appInfo.setDomainNumber("test");
        MenuEntity page = menu(
                301L, 430000000000000002L, 0L, MenuLevelEnum.PAGE, "测试单据",
                "/test/document");
        ...
        assertEquals("测试单据", result.getRoutes().getFirst().getName());
    }
